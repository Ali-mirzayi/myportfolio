...
export default function Scroll() {
    ...
    return (
        <Box sx={{ backgroundColor: "#00092e", position: "relative" }}>
            <div className={styles.container} ref={textRef} style={{ height: "fit-content" }}>
                {permition ?
                    <div>
                        ...
                        <div style={{ position: "absolute", top: "370px", width: "100vw", display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <motion.h2 className={styles.h2} style={{ y: h2, WebkitTextStroke: "2px white", color: "transparent", textAlign: "center" }}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, aut possimus quae praesentium amet enim natus.</motion.h2>
                        </div>
                    </div> : null}
                <div>
            ...
            <motion.div className={styles.container} ref={ref} style={{ opacity: scrollYProgress, height: "200vh" }} />
